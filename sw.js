...
const urlsToCache = [
  ...
  '/adharaglowstudio/admin.html',
  '/adharaglowstudio/admin-login.html',
  '/adharaglowstudio/calendar.html',
  '/adharaglowstudio/setup-wizard.html',
  '/adharaglowstudio/editar-negocio.html',
  '/adharaglowstudio/manifest.json',
  '/adharaglowstudio/icons/icon-72x72.png',
  '/adharaglowstudio/icons/icon-96x96.png',
  '/adharaglowstudio/icons/icon-128x128.png',
  '/adharaglowstudio/icons/icon-144x144.png',
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/adharaglowstudio/icons/icon-192x192.png');
          }
